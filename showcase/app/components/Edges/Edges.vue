...
import EdgesCustomLabel from './EdgesCustomLabel.vue'
...
const initialEdges: Edge[] = [
  ...
  { id: 'e3-5', source: '4', target: '5', animated: true, label: 'animated styled edge', style: { stroke: 'red' } },
  {
    ...
    source: '5',
    target: '6',
    label: h(EdgesCustomLabel, { label: 'custom label text' }, {}),
...
<template>
  ...
  >
    <template #edge-custom="props">
      <EdgesCustomEdge v-bind="props" />
    </template>

    <template #edge-custom2="props">
      <EdgesCustomEdge2 v-bind="props" />
    </template>
